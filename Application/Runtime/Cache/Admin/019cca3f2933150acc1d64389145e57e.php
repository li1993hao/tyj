...
<div class="main-container" id="main-container">
    ...
    <div class="btn-group">
        <a class="btn btn-sm btn-primary" href="<?php echo U('add');?>">添加</a>
    ...
    <div class="able-responsive">
        <table class="table table-striped table-bordered table-hover">
            ...
            <?php if(!empty($nodeList)): if(is_array($nodeList)): $i = 0; $__LIST__ = $nodeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$node): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            <?php $__FOR_START_766252047__=0;$__FOR_END_766252047__=$node["level"];for($i=$__FOR_START_766252047__;$i < $__FOR_END_766252047__;$i+=1){ if($i == $node['level']-1): if($node['last']): ?>|__
                                        <?php else: ?>
                                        |--<?php endif; ?>
                                    <?php else: ?>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php endif; } ?>
                        ...
                        <td>
                        <a href="<?php echo U('del?id='.$node['id']);?>" class="ajax-get confirm">删除</a>
                        <a href="<?php echo U('edit?id='.$node['id']);?>" class="ajax-get">编辑</a>
