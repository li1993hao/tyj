                    ...
                    <tr>
                        ...
                        <td>教练等级：
                            <select name="query_technicalGrade">
                                <option value="__whatever__">不限</option>
                                <?php $_result=C('COACH_TECHNICALGRADE');if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($c); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </td>
                        <td>运动项目：
                        ...
                        <td>队内职务：
                            <select name="query_job">
                                <option value="__whatever__">不限</option>
                                <?php $_result=C('COACH_JOB');if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($c); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </td>
    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover">
            ...
            <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo CC('COACH_TECHNICALGRADE',$vo['technicalGrade']);?></td>
