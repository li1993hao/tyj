...
<div class="main-container" id="main-container">
    ...
    <form class="form-horizontal normal-form" action="<?php echo U(add);?>" method="post">
        ...
        <div class="form-group">
            ...
            <div class="controls">
                <input type="text" class="text input-large"  name="eng_name" value="<?php echo ($node['eng_name']); ?>">
            </div>
        </div>
        <div class="form-group">
            <label class="item-label">单位</label>
            <div class="controls">
                <input type="text" class="text input-large"  name="eng_name" value="<?php echo ($node['unit']); ?>">
            </div>
        </div>
