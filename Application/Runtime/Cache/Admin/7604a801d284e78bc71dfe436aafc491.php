...
<div class="main-container" id="main-container">
    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
            <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sport): $mod = ($i % 2 );++$i;?><tr>
                        <td class="center">
                            <label>
                                <input type="checkbox" class="ids ace" name="ids[]" value="<?php echo ($sport["id"]); ?>">
                                <span class="lbl"></span>
                            </label>
                        </td>
                        ...
                        <td>
                            ...
                            <a class="confirm ajax-get" title="删除" href="<?php echo U('del?id='.$sport['id']);?>">删除</a>
                        </td>
