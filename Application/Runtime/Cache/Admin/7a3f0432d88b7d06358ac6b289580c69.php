...
<div class="main-container" id="main-container">
    ...
    <form class="form-horizontal normal-form" action="<?php echo U();?>" method="post">
        ...
        <div class="form-group">
            ...
            <div class="controls">
                <input type="text" class="text input-large" id="name" value="<?php echo ((isset($info["name"]) && ($info["name"] !== ""))?($info["name"]):''); ?>"  name="name"
                       placeholder="">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="controls">
                <input type="text"  class="text input-large"  name="stage" value="<?php echo ($info["stage"]); ?>">
            </div>
        </div>
        <div class="form-group">
            <label class="item-label">开始时间</label><span class="check-tips">(不写表示待定)</span>
            <div class="controls">
                <?php if(!empty($info)): if($info['start_time'] > 0): ?><input type="text" class="date"   name="start_time"  value="<?php echo (date('Y-m-d',$info["start_time"])); ?>"/>
                     <?php else: ?>
                        <input type="text" class="date"   name="start_time"/><?php endif; ?>
                 <?php else: ?>
                    <input type="text" class="date"   name="start_time"/><?php endif; ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="controls">
                <?php if(!empty($info)): if($info['end_time'] > 0): ?><input type="text" class="date"   name="end_time"  value="<?php echo (date('Y-m-d',$info["end_time"])); ?>"/>
                        <?php else: ?>
                        <input type="text" class="date"   name="end_time"/><?php endif; ?>
                    <?php else: ?>
                    <input type="text" class="date"   name="end_time"/><?php endif; ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="controls">
                <input type="text"    name="place" value="<?php echo ((isset($info["place"]) && ($info["place"] !== ""))?($info["place"]):''); ?>" />
            </div>
        </div>
        <div class="form-group">
            <label class="item-label">参加人数</label>
            <div class="controls">
                <input type="text"     name="athlete_num" value="<?php echo ((isset($info["athlete_num"]) && ($info["athlete_num"] !== ""))?($info["athlete_num"]):''); ?>" />
            </div>
        </div>
        <div class="form-group">
...
<script type="text/javascript" src="/tyj/Public/static/js/common.js"></script>
    ...
    <script type="text/javascript">
        ...
        $('.date').datetimepicker('setStartDate', '<?php echo ($years); ?>-01-01');
        $('.date').datetimepicker('setEndDate', '<?php echo ($years); ?>-12-31');
