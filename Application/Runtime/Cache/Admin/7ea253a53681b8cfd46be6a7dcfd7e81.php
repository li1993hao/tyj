...
<div class="main-container" id="main-container">
    ...
    <div class="btn-group">
        <a href="<?php echo U('addComInfo');?>" class="btn btn-primary btn-sm" >
            添加
        </a>
        <a href="<?php echo U('printComInfo');?>" target="_blank" class="btn btn-primary btn-sm" >
            打印
        </a>
    </div>
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover">
            ...
            <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        <td><?php echo (get_com($vo["com_id"],'name')); ?></td>
                        <td><?php echo (date('Y-m',$vo["time"])); ?></td>
                        <td><?php echo (get_sports($vo["sports"],'cp_name')); ?></td>
                        <td><?php echo ($vo["place"]); ?></td>
                        <td><?php echo (cc('COM_MINGCI',$vo["ranking"])); ?></td>
                        <td><?php echo (cc('COM_JIANGPAI',$vo["medal"])); ?></td>
                        <td><?php echo ($vo["remark"]); ?></td>
                        <td><a  href="<?php echo U('addComInfo?id='.$vo['id']);?>">编辑</a>
                            <a class="ajax-get" href="<?php echo U('delComInfo?id='.$vo['id']);?>">删除</a>
                        </td>
