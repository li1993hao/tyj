        ...
        <div class="btn-group ">
            ...
            <ul class="dropdown-menu dropdown-primary">
                <?php if(is_array($types)): foreach($types as $key=>$vo): ?><li>
                        <?php if(($current_type) != $key): ?><a href="<?php echo U('sum?type='.$key);?>"><?php echo ($vo); ?></a><?php endif; ?>
                    </li><?php endforeach; endif; ?>
            </ul>
            <a class="btn btn-sm btn-primary" href="<?php echo U('addSum?type='.$current_type);?>">
                写总结
            </a>
        </div>
        <!-- 高级搜索 -->
                            ...
                            <div class="timeline-item clearfix">
                                ...
                                <div class="widget-box transparent collapsed">
                                    <div class="widget-header widget-header-small">
                                        ...
                                        <span class="widget-toolbar no-border">
                                            <a href="<?php echo U('editSum?id='.$data['id']);?>">
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            <div><?php echo (htmlspecialchars_decode($data["content"])); ?></div>
                                        </div>
                                    </div>
                                </div>
