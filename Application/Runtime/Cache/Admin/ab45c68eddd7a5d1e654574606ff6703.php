...
<div class="main-container" id="main-container">
    ...
    <div class="cf">
        <div class="btn-group">
            ...
            <a class="btn btn-sm btn-primary" href="<?php echo U('add?category_id='.$category_id);?>"  target-form="ids">新增</a>
        </div>
        <!-- 高级搜索 -->
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td>
                        ...
                        <a class="ajax-get" href="<?php echo U('del?category_id='.$category_id).'&ids='.$data['id'];?>">删除</a>
                    </td>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#search").keyup(function(e) {
                if (e.keyCode === 13) {
                    var url = "<?php echo U('news?category_id='.$category_id.'&title=PLACEHODLE');?>";
