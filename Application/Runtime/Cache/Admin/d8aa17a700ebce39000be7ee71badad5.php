...
<div class="main-container" id="main-container">
    ...
    <?php echo ($meta_title); ?>
        ...
        <div class="btn-group ">
            <?php if(is_array($types)): foreach($types as $key=>$vo): if(($current_type) == $key): ?><button data-toggle="dropdown" class="btn btn-sm btn-primary dropdown-toggle"><?php echo ($vo); ?>
                        <span class="icon-caret-down icon-on-right"></span>
                    </button><?php endif; endforeach; endif; ?>

            <ul class="dropdown-menu dropdown-primary">
                <?php if(is_array($types)): foreach($types as $key=>$vo): ?><li>
                        <?php if(($current_type) != $key): ?><a href="<?php echo U('plan?type='.$key);?>"><?php echo ($vo); ?></a><?php endif; ?>
                    </li><?php endforeach; endif; ?>
            </ul>

            <a class="btn btn-sm btn-primary" href="<?php echo U('addPlan?type='.$current_type);?>">
                写计划
            </a>
        </div>
        <!-- 高级搜索 -->
    ...
    <div id="timeline-1" class="">
        <div class="row">
            <div class="col-xs-12 col-sm-10 col-sm-offset-1">
                <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div class="timeline-container">
                        <div class="timeline-label">
                    <span class="label label-primary arrowed-in-right label-lg">
                        <b><?php echo (date('Y-m-d',$data["create_time"])); ?></b>
                    </span>
                        </div>
                            ...
                            <div class="timeline-item clearfix">
                                ...
                                <div class="widget-box transparent collapsed">
                                    <div class="widget-header widget-header-small">
                                        <h5 class="smaller">计划详情</h5>
                                        <span class="widget-toolbar no-border">
                                            <i class="icon-time bigger-110"></i>
                                            <?php echo (date('H:i',$data["create_time"])); ?>
                                        </span>
                                        <span class="widget-toolbar no-border">
                                            <a href="<?php echo U('editPlan?id='.$data['id']);?>">
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            <div class="red"><h5>训练目标</h5></div>
                                            <div><?php echo ($data["target"]); ?></div>
                                            <div class="red"><h5>训练任务</h5></div>
                                            <div><?php echo (htmlspecialchars_decode($data["task"])); ?></div>
                                            <div class="red"><h5>训练安排</h5></div>
                                            <div><?php echo (htmlspecialchars_decode($data["arrange"])); ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <?php if(isset($data["_verify"])): ?><div class="timeline-item clearfix">
                                    <div class="timeline-info">
                                    ...
                                    <div class="widget-box transparent">
                                        <div class="widget-header header-color-red2 widget-header-small">
                                            ...
                                            <span class="widget-toolbar no-border">
                                                <i class="icon-time bigger-110"></i>
                                                 <?php echo (date('Y-m-d',$data["_verify"]["create_time"])); ?>
                                            </span>
