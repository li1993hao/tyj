...
<div class="main-container" id="main-container">
    ...
    <div class="btn-group">
        <a class="btn btn-sm btn-primary" href="<?php echo U('add?type=1');?>">添加</a>
        ...
        <table class="table table-striped  ">
            ...
            <?php if(!empty($nodeList)): if(is_array($nodeList)): $i = 0; $__LIST__ = $nodeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$node): $mod = ($i % 2 );++$i;?><tr class="level" data-level="<?php echo ($node['level']); ?>" >
                        ...
                        <td>
                            ...
                            <?php $__FOR_START_1355915548__=0;$__FOR_END_1355915548__=$node["level"];for($i=$__FOR_START_1355915548__;$i < $__FOR_END_1355915548__;$i+=1){ if($i == $node['level']-1): if($node['last']): ?>|__
                                        <?php else: ?>
                                        |--<?php endif; ?>
                                    <?php else: ?>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php endif; } ?>
                        ...
                        <td>
                            <?php if(($node["status"]) == "1"): ?><a href="<?php echo U('setStatus?status=0&ids='.$node['id']);?>" class="ajax-get">禁用</a>
                                <?php else: ?>
                                <a href="<?php echo U('setStatus?status=1&ids='.$node['id']);?>" class="ajax-get">启用</a><?php endif; ?>
                            <a href="<?php echo U('add?select_id='.$node['id']);?>">添加子项</a>
                            <a href="<?php echo U('add?id='.$node['id']);?>">修改</a>
