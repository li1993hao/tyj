...
<div class="main-container" id="main-container">
    ...
    <?php echo isset($info['id'])?'编辑':'新增';?>链接
...
<script type="text/javascript" src="/tyj/Public/static/js/common.js"></script>
    ...
    <script type="text/javascript" src="/tyj/Public/vendor/uploadify/jquery.uploadify.min.js?ver=<?php echo time();?>"></script>
    <script type="text/javascript">
        Think.setValue("group", "<?php echo ((isset($info["group"]) && ($info["group"] !== ""))?($info["group"]): 't-1'); ?>");
        //上传文件
        /* 初始化上传插件 */
        ...
        function add() {
            ...
            $.post("<?php echo U('');?>",data,function(datas){
                if(datas.status){
                    okAlert(datas.msg);
                    setTimeout(function(){
                        location.reload();
