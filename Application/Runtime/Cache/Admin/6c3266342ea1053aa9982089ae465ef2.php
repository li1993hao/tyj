...
<?php echo ($data[$field['name']]); endswitch;?>
        ...
        <div class="row">
            <form action="<?php echo U();?>" method="post" style="margin-left: 44px" class="form-horizontal normal-form">
                <div class="form-group">
                    <label>审核内容:<span class="check-tips"></span></label>
                    <div>
                ...
                <button class="btn btn-sm btn-primary ajax-post"  type="submit" target-form="form-horizontal">提交</button>
            </form>
        </div>
    </div>
