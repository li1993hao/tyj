...
<div class="main-container" id="main-container">
    ...
    <div class="btn-group">
        <button class="btn btn-sm btn-primary ajax-get confirm" url="<?php echo U('clear');?>">清 空</button>
		<button class="btn btn-sm btn-primary ajax-post confirm" target-form="ids" url="<?php echo U('remove');?>">删 除</button>
    </div>
	<!-- 数据列表 -->
