...
<link rel="stylesheet" href="/tyj/Public/static/css/am.min.css" />
    ...
    <link rel="stylesheet" href="/tyj/public/vendor/unify/css/pages/page_search.css" >
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i; if(isset($info["cover_path"])): ?><div class="row <?php if(($info["is_up"]) == "1"): ?>search-blocks search-blocks-left-orange<?php else: ?>search-blocks search-blocks-left-green<?php endif; ?> ">
                                ...
                                <div class="col-md-8">
                                    <?php if(info.list_color == '#555' ): ?><h4><a href="<?php echo ($info["url"]); ?>"><?php echo ($info["title"]); ?></a></h4>
                                    <?php else: ?>
                                        <h4><a href="<?php echo ($info["url"]); ?>" style="color:<?php echo ($info["list_color"]); ?>}"><?php echo ($info["title"]); ?></a></h4><?php endif; ?>

                                    <p><?php echo (msubstr($info["description"],0,120)); ?></p>
                                    <p><a class="btn-u btn-u-small" href="<?php echo ($info["url"]); ?>">查看全文</a></p>
                                </div>
                            </div>
